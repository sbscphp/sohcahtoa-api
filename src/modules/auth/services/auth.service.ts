  ...
  async getUserProfile(userId: string) {
    ...
    const userProfile = {
      ...
      kyc: user.kyc ? {
        ...
        tin: user.kyc.tin ? partiallyRedactField(user.kyc.tin, 'tin') : null,
        passportNumber: user.kyc.passportNumber ? partiallyRedactField(user.kyc.passportNumber, 'passport') : null,
