 ...
 *         documentType:
 *           type: string
 *           enum: [PASSPORT, VISA, TICKET, RETURN_TICKET, RECEIPT, INVOICE, MEDICAL_LETTER, OVERSEAS_MEDICAL_LETTER, PROFESSIONAL_BODY_LETTER, BVN, NIN, TIN, TCC, UTILITY_BILL, SCHOOL_ADMISSION, FORM_A_DOCUMENT, CORPORATE_BODY_LETTER, PARTNER_INVITATION_LETTER, MEMBERSHIP_CARD, WORK_PERMIT]
 *         fileUrl:
 *           type: string
 *           format: uri
 *         fileName:
